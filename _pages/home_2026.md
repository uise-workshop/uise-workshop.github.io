    ...
    <div id="workshop-photo-carousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img src="{{ "img/photo-1.jpg" | prepend:site.baseurl }}" alt="UISE 2026 photo 1" style="width:100%;">
        </div>
        <div class="item">
          <img src="{{ "img/photo-2.jpg" | prepend:site.baseurl }}" alt="UISE 2026 photo 2" style="width:100%;">
        </div>
        <div class="item">
          <img src="{{ "img/photo-3.jpg" | prepend:site.baseurl }}" alt="UISE 2026 photo 3" style="width:100%;">
        </div>
      </div>
